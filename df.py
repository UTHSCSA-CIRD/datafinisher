...
def db2df(db,csvfile=None,fileclean=True,mincnt=0,returnwhat='file'
  ...
  #foo = con.execute(tablesquery).fetchall()
  #import pdb; pdb.set_trace()
  ...
  # create csv output
  main(con,csvfile,style='concat',dtcp=1,mincnt=float(mincnt))
  # cleanup
  con.close()
...
if __name__ == '__main__':
  ...
  if args.cleanup:
    ...
    DFMeta(args.dbfile,suggestions=suggestor).processRows(outfile=csvfile)
