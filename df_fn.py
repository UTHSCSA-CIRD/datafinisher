...
class DFColStatic:
  def __init__(self,colmeta,colname,rules=deepcopy(rules),suggestions=None
    ...
    self.dfcol = [{'extr':'skip','rulename':'skip','colmeta':None
			  ,'ruledesc':self.incoldesc}]
    self.short_incolid = self.incolid
    self.divIDchosen = 'REMOVEME0-'+self.short_incolid
    self.divIDavailable = 'REMOVEME1-'+self.short_incolid
  ...
  def getHeader(self,*args,**kwargs): return []
  def getMeta(self,*args,**kwargs): return []
  def processCell(self,*args,**kwargs): return []

  def updChoices(self,*args,**kwargs): pass
  def updRules(self,*args,**kwargs): pass
  def updSuggestions(self,*args,**kwargs): pass
  def finalizeChosen(self,*args,**kwargs): pass
