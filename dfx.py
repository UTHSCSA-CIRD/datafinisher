...
from os import path
from df_fn import xmetaj,xfieldj,rulesvalidate,DFMeta,DFCol
...
def update_df(csvin):
  ...
  fw.writerow(newmeta)
  # TESTING
  dfmeta = DFMeta(myheader,rawmeta)
  colmeta=dfmeta.incols['v025_Drvd_Dscrpt']['dat']
  colname=colmeta['colid']
  from rules import autosuggestor
  dfcol = DFCol(colmeta,colname,suggestions=autosuggestor)
